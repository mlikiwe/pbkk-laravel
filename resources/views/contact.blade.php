    ...
    <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-gray-800 rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p class="text-lg text-gray-300 mt-4 leading-relaxed">FOLLOW YA GES YA</p>
                    ...
                    <ul class="mt-12 space-y-8">
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-base ml-4">
                                aspasgata@gmail.com
                            </a>
                        </li>
                        <li class="flex items-center">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href="javascript:void(0)" class="text-white text-base ml-4">
                                Jalan Street no -5, Kelurahan Lurah, Kecamatan Camat, Kabupaten Bupati
                            </a>
                        </li>
                    </ul>

                    <ul class="flex mt-12 space-x-4">
                        <li class="bg-gray-800 hover:bg-gray-800 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
